            ...
            <table style="width: 90%; margin:auto">
                ...
                while($row = $result->fetch_assoc()):
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="get" action="all_subjects_get.php" style="text-align: center;">
                                <input type="hidden" value="<?=urlencode($row['meeting_id'])?>" name="m">
                                <input type="hidden" value="<?=urlencode($row['is_confirmed'])?>" name="c">
